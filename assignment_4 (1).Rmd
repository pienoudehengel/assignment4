...
author: |
  | Pien Oude Hengel
  | p.m.oudehengels@students.uu.nl
...
The null-hypothesis asserts that there is no difference between in means between group More than 0 Revolutions and group No Revolutions is not equal to 0. The p-value represents the probability of observing a test statistic as extreme as the one obtained (or more extreme) if the null hypothesis is true.
